(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["NanoSock"] = factory();
	else
		root["NanoSock"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Events, NanoSock, _;
	
	_ = __webpack_require__(2);
	
	Events = __webpack_require__(3);
	
	NanoSock = function(options) {
	...
	_.extend(NanoSock.prototype, Events, {
	  newSocket: function() {
	    return new WebSocket(this.options.url, this.options.protocol + ".sp.nanomsg.org");
	  },
	  send: function(msg) {
	  ...
	  close: function() {
	    return this.socket.close.apply(this.socket, arguments);
	  },
	  options: {
	    url: null,
	    protocol: null,
	  ...
	  initialize: function(options) {
	    ...
	    _.each(['open', 'close', 'message', 'error'], (function(_this) {
	    ...
	    return typeof window !== "undefined" && window !== null ? typeof window.addEventListener === "function" ? window.addEventListener('beforeunload', (function(_this) {
	      return function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;//     Underscore.js 1.8.1
...
/***/ function(module, exports, __webpack_require__) {
	...
	/*$AMPERSAND_VERSION*/
	var runOnce = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var limitCalls = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var objKeys = __webpack_require__(6);
	var createCallback = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var isNumber = __webpack_require__(24);
...
//# sourceMappingURL=nanosock.js.map